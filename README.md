...
## Generate online documentation
 ...
 - this page is automatically generated by GitHub every time you push to the master branch (this template repo is set up that way using GitHub actions) but it will only be publicly accessible if you enable it for your repo: go to your repository **Settings** --> **GitHub Pages** --> **Source**: select `gh-pages` branch
