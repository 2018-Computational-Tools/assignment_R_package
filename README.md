...
## Generate online documentation
 ...
 - this page is automatically generated by GitHub every time you push to the master branch (this template repo is set up that way using GitHub actions) and is available at https://cub-computational-tools.github.io/YOUR_REPO_NAME/ once generated successfully. To check this, go to your repository **Settings** --> **GitHub Pages** --> **Source** (should be set to `gh-pages` branch)
...
## Continuous integration
 ...
 - to enable continuous integration, run `usethis::use_github_action_check_standard()` and copy the resulting badge cody into your readme as instructed
